...
echo "=============================================="
echo "  Compilando shared_memory_cross_read_tb"
echo "=============================================="
...
vcs -sverilog -full64 -timescale=1ns/1ps \
    ...
    shared_memory_cross_read_tb.sv \
    -o simv \
    | tee logs/compile_shared_memory_cross_read.log

echo "=============================================="
echo "  Ejecutando simulación"
echo "=============================================="

./simv | tee logs/run_shared_memory_cross_read.log
