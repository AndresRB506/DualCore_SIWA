...
# DVE full session
# Saved on Mon Nov 5 18:01:42 2018
# Designs open: 1
...
#<Session mode="Full" path="/mnt/vol_NFS_Zener/WD_ESPEC/DPalacios/riscv_test/Verificacion_RISCV_TEC/test_env/uvm_alu/DVEfiles/session.tcl" type="Coverage">
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{18 67} {1357 738}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 388} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1339} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_update_layout -id ${CoverageTable.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {Layout_CoverageTable_covtblFGroupsList_names Group,    , ,  ,   ,Score,Assert,Covergroup,} {Layout_CoverageTable_covtblFGroupsList_widths 220,0,25,0,0,125,125,125,} {Layout_CoverageTable_covtblFGroupsList_orders 4,0,1,2,3,5,6,7,} {Layout_CoverageTable_covtblInstancesList_names Name,    , ,  ,   ,Score,Line,Assert,} {Layout_CoverageTable_covtblInstancesList_widths 220,0,25,0,0,125,125,125,} {Layout_CoverageTable_covtblInstancesList_orders 4,0,1,2,3,5,6,7,} {Layout_CoverageTable_covtblModulesList_names Name,    , ,  ,   ,Score,Line,Assert,} {Layout_CoverageTable_covtblModulesList_widths 220,0,25,0,0,125,125,125,} {Layout_CoverageTable_covtblModulesList_orders 4,0,1,2,3,5,6,7,}}
...
catch {gui_list_expand -id ${CovHier.1} tbench_top}
catch {gui_list_expand -id ${CovHier.1} tbench_top.DUT}
catch {gui_list_expand -id ${CovHier.1} tbench_top}
catch {gui_list_expand -id ${CovHier.1} tbench_top.DUT}
catch {gui_list_expand -id ${CovHier.1} tbench_top.DUT}
catch {gui_list_expand -id ${CovHier.1} {/<Function Groups>}}
catch {gui_list_expand -id ${CovHier.1} {/<Function Groups>/alu_if::ALU}}
catch {gui_list_expand -id ${CovHier.1} {/<Function Groups>/alu_if::ALU}}
catch {gui_list_select -id ${CovHier.1} {{/<Function Groups>/alu_if::ALU}}}
gui_covtable_show -id CoverageTable.1 -show {Design Hierarchy}  -cumulative 1
catch {gui_list_select -id ${CoverageTable.1} {tbench_top}}

# Source 'CovDetail.1'
gui_src_value_annotate -id ${CovDetail.1} -switch false
gui_set_env TOGGLE::VALUEANNOTATE 0
gui_open_source -id ${CovDetail.1}  -replace -active tbench_top.intf::ALUMergedTest -type {Cover Group}  /mnt/vol_NFS_Zener/WD_ESPEC/DPalacios/riscv_test/Verificacion_RISCV_TEC/test_env/uvm_alu/alu_interface.sv
gui_src_value_annotate -id ${CovDetail.1} -switch true
gui_set_env TOGGLE::VALUEANNOTATE 1
gui_view_scroll -id ${CovDetail.1} -vertical -set 1035
gui_src_set_reusable -id ${CovDetail.1}
gui_cov_populate_fun -id CovDetail.1 -name {alu_if::ALUMergedTest} -type {Cover Group}
...
gui_covdetail_select -id CovDetail.1 -test MergedTest
gui_list_expand -id CovDetail.1  /alu_if::ALU
gui_list_expand -id CovDetail.1  /alu_if::ALU/tbench_top.intf::ALU
gui_list_expand -id CovDetail.1  /alu_if::ALU/tbench_top.intf::ALU
catch { gui_list_select -id CovDetail.1  -list {covergroup}  {tbench_top.intf::ALU.Control}}
gui_covdetail_select -id CovDetail.1 -name Covergroup
