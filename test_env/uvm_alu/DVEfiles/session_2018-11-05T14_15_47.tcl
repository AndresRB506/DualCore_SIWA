...
# DVE full session
# Saved on Mon Nov 5 14:15:08 2018
# Designs open: 1
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{16 65} {1357 738}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 390} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1341} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
catch {gui_list_select -id ${CovHier.1} {{/<Function Groups>/alu_if::ALU/tbench_top.intf::ALU}}}
gui_covtable_show -id CoverageTable.1 -show {Design Hierarchy}  -cumulative 1
gui_covtable_setroot -id CoverageTable.1 {tbench_top}  -type {Scope} 
...
gui_cov_populate_fun -id CovDetail.1 -name {tbench_top.intf::ALUMergedTest} -type {Cover Group}
...
gui_covdetail_select -id CovDetail.1 -test MergedTest
gui_list_expand -id CovDetail.1  /tbench_top.intf::ALU
