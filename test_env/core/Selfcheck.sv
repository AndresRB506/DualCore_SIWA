  task selfcheck(input string inst_queue [$], input string prediction [$], input int executed_inst, input string exe_inst_queue [$]);
    string        file1;
    string        file2;
    string        results        [$];
    string        data1          [$];
    ...
    $display("-----------------------------------",);
    $display("Total Number of Instructions: %d",(inst_queue.size() - 1));
    //executed_inst_count(file1,executed_inst);
    $display("Total Number of Executed Instructions: %d",(executed_inst - 1));
    $display("\n---------------------------------------");    
    $display("------RTL result-----");
    $display("---------------------------------------");
    for (int inst_cont = 1; inst_cont < executed_inst; inst_cont++) begin
      ...
      load_RTL_data(file2, inst_cont, data2);
  ...
  task compare(input string str_queue1 [$], input string str_queue2 [$], input string exe_inst_queue [$]); //prediction,results,instruction number
  ...
  task load_RTL_data(input string str, input int inst_num, output string data[$]);
    int out;
    int pc;
    int prev_pc;
    int count;
