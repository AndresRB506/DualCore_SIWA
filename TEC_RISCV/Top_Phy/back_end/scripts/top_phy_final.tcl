...
create_floorplan  -control_type width_and_height -core_width 1500 -core_height 1120 -core_utilization 0.8 -left_io2core 20 -bottom_io2core 20 -right_io2core 20 -top_io2core 20;
...
#create_floorplan -control_type width_and_heigth -core_width 2500 -core_heigth 1500 -core_utilization 0.8 -left_io2core 20 -bottom_io2core 20 -right_io2core 20 -top_io2core 20;
...
#derive_pg_connection
derive_pg_connection -tie#derive_pg_connection -power_net VDD -ground_net VSS -tie
...
preroute_standard_cells -nets VDD -fill_empty_rows -remove_floating_pieces -connect horizontal; # -extend_to_boundaries_and_generate_pins
...
copy_mw_cel -from  place_ends -to fill_ends

open_mw_cel fill_ends
...
save_mw_cell fill_ends
copy_mw_cel -from fill_ends  -to clock_tree_placed
...
route_zrt_auto -max_detail_route_iterations 30 ; #40
verify_zrt_route
psynopt -congestion
route_zrt_auto -max_detail_route_iterations 30; #40
route_opt -incremental
route_zrt_detail -incremental true -max_number_iterations 30; #40
