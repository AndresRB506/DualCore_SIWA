...
/***********************************************************************************************/
module csr_file #(parameter width=32, parameter number_reg=12)(Din, Dout1, addres1, Write_en, clk, rst , mip_IO, mip_time, mie_IO, mie_time, comparation, timer, full_range_level_shifter, IS_Val, IS_Config, IS_Trigger, Mie_analogic, mip_analogic,Reg_GPIO_en,Reg_GPIO_int,Reg_GPIO_out);
