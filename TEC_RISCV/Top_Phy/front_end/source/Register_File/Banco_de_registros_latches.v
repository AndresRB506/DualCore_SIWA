...
module Banco_registros_latches(csr_id, rs1, rs2, rd, csr_write, reg_write_data, write, R1, R2, clk, rst, mip_IO, mip_time, mie_time, mie_IO, comparation, timer,CSR, full_range_level_shifter, IS_Val, IS_Config, IS_Trigger, Mie_analogic, mip_analogic,Reg_GPIO_en,Reg_GPIO_int,Reg_GPIO_out);
parameter width=32;
