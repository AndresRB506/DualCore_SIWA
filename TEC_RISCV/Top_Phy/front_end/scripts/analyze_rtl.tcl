...
if {$COMPLETE_COMPILE==1} {
	# Se abre la biblioteca de trabajo Milkyway. En caso de que la misma no exista se crea.
	read_file -format sverilog {/mnt/vol_NFS_Zener/WD_ESPEC/rgarcia/GIT/TEC_RISCV/Top_Phy/front_end/source/TOP_PADS/top_riscv_tec_pads.sv} > reports/results_read.txt;
