...
set_domain_supply_net {ucu_anlg1/PD_UCU} -primary_power_net {ucu_anlg1/VDD_3V3_UCU}  -primary_ground_net {ucu_anlg1/VSS};
set_domain_supply_net {pad_ring_inst/PD_PADS} -primary_power_net {pad_ring_inst/VDD_3V3_PADS} -primary_ground_net {pad_ring_inst/VSS}
