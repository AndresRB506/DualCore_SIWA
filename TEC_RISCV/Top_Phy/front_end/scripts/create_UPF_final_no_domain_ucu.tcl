...
create_supply_net VDD_1V8   -domain {PD_UCU} -reuse
...
#Prueba, sin conectar el puerto de 1.8 al bloque de la ucu
...
create_supply_port VDD_3V3_UCU -domain UCU
...
create_supply_net VSS -domain PD_UCU -reuse
...
set_domain_supply_net {PD_UCU} -primary_power_net {VDD_1V8}  -primary_ground_net {VSS};
