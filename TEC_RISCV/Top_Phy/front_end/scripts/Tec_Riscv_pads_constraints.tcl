...
set_driving_cell -lib_cell $DRIVING_CELL -library $LIB_NAME_PADS  $ALL_IN_EX_CLK_NAME
...
set_max_capacitance $MAX_LOAD_IN  $ALL_IN_EX_CLK_NAME
...
set_load [expr $MAX_LOAD_OUT *1 ] $ALL_OUT_NAME
...
if {![shell_is_in_topographical_mode]} {
	set_switching_activity -toggle_rate 0.25 -static_probability 0.5 -base_clock clk $ALL_IN_EX_CLK_NAMES;
}
