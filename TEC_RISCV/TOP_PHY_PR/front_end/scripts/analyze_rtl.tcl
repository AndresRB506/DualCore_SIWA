...
if {$COMPLETE_COMPILE==1} {
	...
	read_file -format sverilog {/mnt/vol_NFS_Zener/WD_ESPEC/rgarcia/GIT/TEC_RISCV/TOP_PHY_PR/front_end/source/TOP_PADS/top_riscv_tec_pads.sv} > reports/results_read.txt;
