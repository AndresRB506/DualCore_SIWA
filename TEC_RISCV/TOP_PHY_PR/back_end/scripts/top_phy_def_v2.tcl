...
source ./scripts/create_basic_design_def_v2.tcl
...
source ./scripts/create_voltage_areas_def_v3.tcl
...
#Scamos las filas bordeando el dominio de voltaje por el lado derecho de la SRAM para que prerutear VDDs ni VSS ahi
#cut_row -within {{885 589.480} {908 1337.640}}
cut_row -within {{893 582.485} {918 1330.925}}

#Sacamos 10 filas de STD CELLS para que no ponga sites ahi
#Sacamos las filas bordeando el dominio de voltaje en la base de la SRAM sobre los riels de VDDs y VSS ahi

cut_row -within {{189.420 537.685} {915 1330.925}}
#Sacamos 10 filas de STD CELLS para que no ponga sites ahi
#Sacamos las filas en los rieles inferiores VDDs ni VSS ahi
cut_row -within {{189.420 188.245} {1497.020 233.045}}

#Sacamos 10 filas de STD CELLS para que no ponga sites ahi
#Sacamos las filas en los rieles superiores VDDs ni VSS ahi

cut_row -within {{189.420 1290.325} {1497.020 1330.925}}
...
source ./scripts/power_nets_syn_v2.tcl
...
#Primer bloque para evitar rutear sobre SRAM

#create_routing_blockage -layers {metal1Blockage metal2Blockage metal3Blockage metal4Blockage metal5Blockage metal6Blockage} -bbox {{893.060 607.125} {898.660 1330.645}}
...
#Bloque que evita ruteo por el area de pads que va a la UCU

create_routing_blockage -layers {metal1Blockage metal2Blockage metal3Blockage metal4Blockage metal5Blockage metal6Blockage} -bbox {{1313.760 1353.040} {1520.000 1359.760}}

# Para que el router honore los bloqueos
...
#create_net_shape -net VDD_1V8SRAM -type wire -route_type pg_macro_io_pin_conn -layer METTP -bbox { {170.00 590.000} {893.0 600.00} }
#create_net_shape -net VDD_1V8SRAM -type wire -route_type pg_macro_io_pin_conn -layer METTPL -bbox { {170.00 590.000} {180.0 692.00} } -vertical
...
###
################# Rellenamos los pads antes de rutear #############3
##source ./scripts/pad_filling.tcl
#### Verificamos que los pines ahora queden conectados
verify_pg_nets
###############################################################3
