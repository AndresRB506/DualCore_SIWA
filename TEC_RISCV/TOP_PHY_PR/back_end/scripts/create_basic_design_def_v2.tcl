...
if {$CREATE_FLOORPLAN==1} {
		open_mw_cel top_riscv_tec_pads
		source ./scripts/create_pads_def_v2.tcl
...
# Este ajuste final nos da exactamente la distancia que queremos
  #  -left_io2core $SLIVER_SIZE -bottom_io2core $SLIVER_SIZE -right_io2core $SLIVER_SIZE -top_io2core $SLIVER_SIZE;
	#adjust_fp_io_placement -side b -pitch 104.0 -offset 189.5 (el que teniamos
		adjust_fp_io_placement -side l -spacing 22.0 -offset 189
		adjust_fp_io_placement -side b -spacing 22.0 -offset 189
		adjust_fp_io_placement -side t -spacing 22.0 -offset 189
