...
#Se definen los atributos de PAD para los pines de alimentacion (PG)
set_attribute -type boolean [get_pins -all   vdd_1v8_core_left/VDDC] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_core_up/VDDC] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_core_down_1/VDDC] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_core_down_2/VDDC] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_sram_left/VDDC] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_pad_up/VDD] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_pad_left/VDD] is_pad true
set_attribute -type boolean [get_pins -all   vdd_1v8_pad_down/VDD] is_pad true
set_attribute -type boolean [get_pins -all   vdd_3v3_pad_up/VDDOR] is_pad true
set_attribute -type boolean [get_pins -all   vdd_3v3_pad_down/VDDOR] is_pad true
set_attribute -type boolean [get_pins -all   vss_left_1/GNDOR] is_pad true
set_attribute -type boolean [get_pins -all   vss_left_2/GNDOR] is_pad true
set_attribute -type boolean [get_pins -all   vss_up_1/GNDOR] is_pad true
set_attribute -type boolean [get_pins -all   vss_up_2/GNDOR] is_pad true
set_attribute -type boolean [get_pins -all   vss_bottom_1/GNDOR] is_pad true
set_attribute -type boolean [get_pins -all   vss_bottom_2/GNDOR] is_pad true
