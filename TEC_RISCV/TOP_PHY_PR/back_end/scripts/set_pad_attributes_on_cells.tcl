# Auto generado por la herramienta al arrancar
#Tomado de archivo ./backend/set_pad_attributes_on_cell_top_riscv_tec_pads.tcl
...
## Debemos generar lo mismo para los level shifters

#set_attribute -type boolean [get_pins ucu_anlg1/*HV_inst/Q] is_pad true
