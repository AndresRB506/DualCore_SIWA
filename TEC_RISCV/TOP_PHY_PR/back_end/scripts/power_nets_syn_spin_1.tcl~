...
## La regla de MET5 (W5MT) dice que no puede ser mas de 17 um de alto (17 x17 maxima region METTP)
# Definimos el alto maximo de 3.5 $CELL_HEIGHT)
set MAX_RING [expr 3.5 * $CELL_HEIGHT]
set MIN_RING [expr 3 * $CELL_HEIGHT]
