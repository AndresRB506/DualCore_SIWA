...
#create_cell {cornerlb cornerlu cornerrb cornerru} CORNERSF;
create_cell {cornerlb cornerlu} CORNERSF;

#Creamos 6 PADs VSS (GND general del circuito)
create_cell {vss_left_1  vss_left_2 vss_up_1   vss_up_2 vss_bottom_1 vss_bottom_2} GNDORPADF;

#Creamos 3 PADs VDD 1.8 para PADs (alimentan VDD de los PADS)
create_cell {vdd_1v8_pad_up vdd_1v8_pad_left vdd_1v8_pad_down} VDDPADF;

#Creamos 4 PADs VDD 1.8 CORE
...
#set_pad_physical_constraints -pad_name "cornerru" -side 2
#set_pad_physical_constraints -pad_name "cornerrb" -side 3
set_pad_physical_constraints -pad_name "cornerlb" -side 4


# Colocamos los PADs a la izquierda
set_pad_physical_constraints -pad_name "pad_ring_inst/pad_bit_7__inout_pad_inst" -side 1  -order 11
set_pad_physical_constraints -pad_name "pad_ring_inst/pad_bit_6__inout_pad_inst" -side 1  -order 10
set_pad_physical_constraints -pad_name "pad_ring_inst/maip_pad_inst"             -side 1  -order 9
set_pad_physical_constraints -pad_name "pad_ring_inst/MISO_pad_inst"             -side 1  -order 8
set_pad_physical_constraints -pad_name "vdd_1v8_pad_left"              		-side 1 -order 7
set_pad_physical_constraints -pad_name "pad_ring_inst/MOSI_pad_inst"     	-side 1  -order 6
set_pad_physical_constraints -pad_name "vdd_1v8_sram_left"                       -side 1 -order 5
set_pad_physical_constraints -pad_name "pad_ring_inst/SCLK_pad_inst"    	-side 1  -order 4
set_pad_physical_constraints -pad_name "vss_left_1"                               -side 1 -order 3
set_pad_physical_constraints -pad_name "vdd_1v8_core_left"             		 -side 1  -order 2
set_pad_physical_constraints -pad_name "vss_left_2"             		 -side 1 -order 1




# Colocamos los PADs de abajo
set_pad_physical_constraints -pad_name "pad_ring_inst/SCS_pad_inst"     -side 4  -order 1
set_pad_physical_constraints -pad_name "pad_ring_inst/RX_UART_pad_inst" -side 4 -order 2
set_pad_physical_constraints -pad_name "pad_ring_inst/TX_UART_pad_inst" -side 4 -order 3
set_pad_physical_constraints -pad_name "vdd_3v3_pad_down"              -side 4 -order 4
set_pad_physical_constraints -pad_name "vss_bottom_2"                  -side 4  -order 5
set_pad_physical_constraints -pad_name "vdd_1v8_core_down_1"           -side 4  -order 6
set_pad_physical_constraints -pad_name "pad_ring_inst/reset_pad_inst"   -side 4  -order 7
set_pad_physical_constraints -pad_name "vdd_1v8_pad_down"              -side 4 -order 8
set_pad_physical_constraints -pad_name "pad_ring_inst/clk_pad_inst"    -side 4  -order 9
set_pad_physical_constraints -pad_name "vss_bottom_1"                  -side 4  -order 10 
set_pad_physical_constraints -pad_name "vdd_1v8_core_down_2"          -side 4 -order 11
